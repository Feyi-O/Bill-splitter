...
* **Equal Division:** Splits the final total, including the tip, evenly among 4 friends[cite: 2].
...
1. Open `Bill splitter.py` in Visual Studio Code (or your preferred editor).
